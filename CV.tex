...
%      \CVItemListEnd
    \CVSubheading
      ...
      \CVItemListStart
        \CVItem{Translation of Roddy-based ODCF bioinformatic pipelines into NextFlow }
        \CVItem{Optimization and scientific workflow engineering using nf-core platform, cloud technologies, and different platforms}
        \CVItem{Preparation and presentation of NGS harmonization workshops}        
